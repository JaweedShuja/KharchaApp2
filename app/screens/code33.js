    ...
    getValues(email){
      ...
      activityRef.on('value', (snapshot) => {
        ...
        for(let item in items){
          this.setState({
            EatingOut:items[item].EatingOut,
            Education:items[item].Education,
            Grocery:items[item].Grocery,
            Medical:items[item].Medical,
            Other:items[item].Other,
            Personal:items[item].Personal,
          })
        }
...
<View style={styles.recenTransationContainer}>
        ...
        <View style={styles.content}>
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','EatingOut');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
             style={[styles.contentTab, {backgroundColor:'white', borderTopLeftRadius:5,borderTopRightRadius:5,}]}>
              ...
              <View style={styles.contentTxt}>
                  <Text style={{fontSize:20, fontWeight:'bold',color:'#3b99af'}}>
                    Eating-Out
                  </Text>  
              </View>
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','Education');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','Grocery');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
             style={[styles.contentTab, {backgroundColor:'white'}]}>
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','Medical');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
             style={[styles.contentTab, {backgroundColor:'white'}]}>
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','Personal');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
             style={[styles.contentTab, {backgroundColor:'white'}]}>
            ...
            onPress={
              () => {
                this.gotoDetails('ExpenseTypeView','Other');
              }
            }
            //onPress={() => this.props.navigation.navigate('ExpenseTypeView')}
             style={[styles.contentTab, {backgroundColor:'white', borderBottomLeftRadius:5,borderBottomRightRadius:5,}]}>
